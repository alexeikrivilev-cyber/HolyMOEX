...
VALUES (
  ...
  'info',
  'portfolio_identity_readiness_refined',
  'Live readiness now evaluates the latest broker-synced Portfolio State snapshot, so controlled staging snapshots cannot mask ArenaGo portfolio identity mismatches.',
  'migration',
  '018_portfolio_identity_readiness_refinement',
  ARRAY['portfolio_identity', 'broker_synced_snapshot', 'controlled_staging_ignored'],
  '{"migration":"018_portfolio_identity_readiness_refinement.sql"}'::jsonb
);
