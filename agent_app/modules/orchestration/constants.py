...
DEFAULT_DEPENDENCY_EDGES: tuple[dict[str, object], ...] = (
    ...
    {"source": "Market Data Metrics Module", "target": "Feature Store", "critical": True},
    {"source": "Liquidity & Microstructure Module", "target": "Feature Store", "critical": True},
    {"source": "Volatility & Risk Metrics Module", "target": "Feature Store", "critical": True},
    {"source": "Market Context Module", "target": "Feature Store", "critical": True},
    {"source": "Event & News Intelligence Module", "target": "Feature Store", "critical": False},
    {"source": "Earnings & Dividend Intelligence Module", "target": "Feature Store", "critical": False},
    {"source": "Fundamental & Valuation Module", "target": "Feature Store", "critical": False},
