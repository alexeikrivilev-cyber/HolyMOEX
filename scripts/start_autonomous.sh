...
export DECISION_ALLOW_SHORT_SELLING="${DECISION_ALLOW_SHORT_SELLING:-false}"
...
export DECISION_ACTION_THRESHOLD="${DECISION_ACTION_THRESHOLD:-0.012}"
export DECISION_MIN_POST_COST_EDGE_SCORE="${DECISION_MIN_POST_COST_EDGE_SCORE:-0.012}"
export DECISION_MACRO_EDGE_PENALTY_CAP="${DECISION_MACRO_EDGE_PENALTY_CAP:-0.006}"
...
export DECISION_MIN_TARGET_POSITION_PCT="${DECISION_MIN_TARGET_POSITION_PCT:-0.012}"
export DECISION_TARGET_FULL_EDGE_SCORE="${DECISION_TARGET_FULL_EDGE_SCORE:-0.18}"
export DECISION_DEGRADED_CONTEXT_TARGET_MULTIPLIER="${DECISION_DEGRADED_CONTEXT_TARGET_MULTIPLIER:-0.65}"
export DECISION_MACRO_DEGRADED_EDGE_PENALTY="${DECISION_MACRO_DEGRADED_EDGE_PENALTY:-0.0}"
export DECISION_MACRO_OVERLAY_SHORT_BIAS_ENABLED="${DECISION_MACRO_OVERLAY_SHORT_BIAS_ENABLED:-false}"
export RISK_MIN_LOT_ROUND_UP_EDGE_AFTER_COST_FLOOR="${RISK_MIN_LOT_ROUND_UP_EDGE_AFTER_COST_FLOOR:-0.012}"
export SAFE_LIVE_SUBMIT="${SAFE_LIVE_SUBMIT:-false}"
export LIVE_READINESS_PASSED="${LIVE_READINESS_PASSED:-false}"
export ALLOW_ARENA_GO_TOKEN_FALLBACK="${ALLOW_ARENA_GO_TOKEN_FALLBACK:-false}"
...
export LLM_MAX_ITEMS_PER_RUN="${LLM_MAX_ITEMS_PER_RUN:-5}"
export LLM_MAX_CALLS_PER_MINUTE="${LLM_MAX_CALLS_PER_MINUTE:-6}"
export LLM_MAX_CALLS_PER_HOUR="${LLM_MAX_CALLS_PER_HOUR:-120}"
export LLM_MAX_CALLS_PER_DAY="${LLM_MAX_CALLS_PER_DAY:-1000}"
export LLM_MIN_SECONDS_BETWEEN_CALLS="${LLM_MIN_SECONDS_BETWEEN_CALLS:-1}"
export ENABLE_LLM_TEXT_SCHEDULES="${ENABLE_LLM_TEXT_SCHEDULES:-true}"
export EVENT_NEWS_DISCOVERY_INTERVAL_SECONDS="${EVENT_NEWS_DISCOVERY_INTERVAL_SECONDS:-120}"
export EVENT_NEWS_FAST_INTERVAL_SECONDS="${EVENT_NEWS_FAST_INTERVAL_SECONDS:-120}"
export EVENT_NEWS_MAX_ITEMS_PER_RUN="${EVENT_NEWS_MAX_ITEMS_PER_RUN:-5}"
export EVENT_NEWS_ONLY_UNPROCESSED_RAW_TEXT="${EVENT_NEWS_ONLY_UNPROCESSED_RAW_TEXT:-true}"
export EVENT_NEWS_FAST_FIRST="${EVENT_NEWS_FAST_FIRST:-true}"
export EVENT_NEWS_REASONING_ESCALATION_ENABLED="${EVENT_NEWS_REASONING_ESCALATION_ENABLED:-true}"
export EVENT_NEWS_ESCALATE_MATERIALITY_THRESHOLD="${EVENT_NEWS_ESCALATE_MATERIALITY_THRESHOLD:-0.70}"
export EVENT_NEWS_ESCALATE_SENTIMENT_ABS_THRESHOLD="${EVENT_NEWS_ESCALATE_SENTIMENT_ABS_THRESHOLD:-0.65}"
...
export SCHEDULER_LOCK_TTL_SECONDS="${SCHEDULER_LOCK_TTL_SECONDS:-300}"
...
if [ -z "${POLZA_API_KEY:-}" ] && [ "${LLM_ENABLED:-}" = "true" ]; then
  echo "warning: POLZA_API_KEY is not set; disabling LLM text schedules for deterministic runtime"
  export LLM_ENABLED=false
  export ENABLE_LLM_TEXT_SCHEDULES=false
fi
