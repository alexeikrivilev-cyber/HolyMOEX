...
export ARENA_GO_SHORTS_ALLOWED="${ARENA_GO_SHORTS_ALLOWED:-true}"
...
export DECISION_SHORT_ENTRY_THRESHOLD="${DECISION_SHORT_ENTRY_THRESHOLD:-0.012}"
export DECISION_SHORT_ADD_THRESHOLD="${DECISION_SHORT_ADD_THRESHOLD:-0.018}"
...
export MARKET_SESSION_SOURCE="${MARKET_SESSION_SOURCE:-auto}"
export ARENA_GO_SESSION_PROBE_ENABLED="${ARENA_GO_SESSION_PROBE_ENABLED:-true}"
export ARENA_GO_SESSION_PROBE_REQUIRED_FOR_OPEN="${ARENA_GO_SESSION_PROBE_REQUIRED_FOR_OPEN:-true}"
export ARENA_GO_SESSION_PROBE_INTERVAL_SECONDS="${ARENA_GO_SESSION_PROBE_INTERVAL_SECONDS:-120}"
export ARENA_GO_SESSION_PROBE_MAX_AGE_SECONDS="${ARENA_GO_SESSION_PROBE_MAX_AGE_SECONDS:-300}"
export ARENA_GO_SESSION_PROBE_REQUIRE_POSITIONS="${ARENA_GO_SESSION_PROBE_REQUIRE_POSITIONS:-true}"
export ARENA_GO_MARKET_CLOSED_COOLDOWN_SECONDS="${ARENA_GO_MARKET_CLOSED_COOLDOWN_SECONDS:-180}"
export ARENA_GO_MARKET_TIMEZONE="${ARENA_GO_MARKET_TIMEZONE:-Europe/Moscow}"
export ARENA_GO_MARKET_EXTENDED_SESSION="${ARENA_GO_MARKET_EXTENDED_SESSION:-true}"
export ARENA_GO_MARKET_OPEN_TIME="${ARENA_GO_MARKET_OPEN_TIME:-10:00}"
export ARENA_GO_MARKET_CLOSE_TIME="${ARENA_GO_MARKET_CLOSE_TIME:-23:50}"
export ALLOW_ARENA_GO_EXTENDED_MARKET_DATA_GRACE="${ALLOW_ARENA_GO_EXTENDED_MARKET_DATA_GRACE:-true}"
export ARENA_GO_EXTENDED_MARKET_DATA_GRACE_SECONDS="${ARENA_GO_EXTENDED_MARKET_DATA_GRACE_SECONDS:-21600}"
export ARENA_GO_EXTENDED_LOOKBACK_MINUTES="${ARENA_GO_EXTENDED_LOOKBACK_MINUTES:-480}"
...
export ENABLE_LLM_TEXT_SCHEDULES="${ENABLE_LLM_TEXT_SCHEDULES:-true}"
